...
//import images
import user1 from "../../assets/images-for-landing/user/img-2.jpg";
import user2 from "../../assets/images-for-landing/user/img-3.jpg";
import user3 from "../../assets/images-for-landing/user/img-1.jpg";
import Background from "../../assets/images-for-landing/cta-bg.png";
import demo from "../../assets/images-for-landing/demos.png";
    ...
    <React.Fragment>
      ...
      >
        <Container>
          <Row>
            <Col lg={12}>
              <Card className="bg-gradient-primary text-center border-0 blog-text">
                <div
                  className="bg-overlay-img"
                  style={{ background: `url(${demo})` }}
                ></div>
                <Card.Body className="mx-auto p-sm-5 p-4">
